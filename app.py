...
def render_sidebar() -> None:
    ...
    with st.sidebar:
        ...
        st.subheader("Source")
        # Ensure source defaults safely before segmented_control
        if st.session_state.source not in ("Sample threads", "Gmail via engine.py"):
            st.session_state.source = "Sample threads"
        st.session_state.source = st.segmented_control(
            "Source",
            options=["Sample threads", "Gmail via engine.py"],
            default=st.session_state.source,
