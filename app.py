...
.stApp {
    background: 
        radial-gradient(circle at 15% 100%, rgba(236, 72, 153, 0.45) 0%, transparent 50%), /* Vibrant Pink glow bottom left */
        radial-gradient(circle at 85% 100%, rgba(168, 85, 247, 0.45) 0%, transparent 50%), /* Vibrant Purple glow bottom right */
        radial-gradient(circle at 50% 100%, rgba(56, 189, 248, 0.55) 0%, transparent 60%), /* Light Cyan center */
        linear-gradient(180deg, #020617 0%, #0f172a 35%, #1e3a8a 70%, #174276 100%) !important; /* Deep space to vibrant blue base */
