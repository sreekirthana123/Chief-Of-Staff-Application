...
def render_aurora_landing_page(auth_url: str) -> None:
    ...
    st.markdown(
        ...
        .stApp::before {
            ...
            opacity: 0.85; /* Much stronger glitter */
            z-index: 0;
            pointer-events: none;
        }
        ...
        /* DARKER GLASS CARD FOR CONTRAST AGAINST VIBRANT BACKGROUND */
        .glass-card {
        ...
        .card-title {
            ...
            color: #90e0ef; /* Light blue heading */
        ...
        strong { color: #90e0ef; font-weight: 700; } /* Highlighted bold text */
