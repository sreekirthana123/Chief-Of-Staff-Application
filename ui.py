    ...
    .element-container > div,
      ul li,  /* Unordered lists */
       ol li {  /* Ordered lists */ 
        ...
        .stApp {
            background: 
                radial-gradient(circle at 15% 100%, rgba(255, 145, 175, 0.65) 0%, transparent 65%),
                radial-gradient(circle at 85% 100%, rgba(229, 120, 143, 0.45) 0%, transparent 50%),
                radial-gradient(circle at 100% 100%, rgba(229, 110, 148, 0.55) 0%, transparent 60%),
