    ...
    .element-container > div,
      ul li,  /* Unordered lists */
       ol li {  /* Ordered lists */ 
        ...
        .stApp {
            background: 
                radial-gradient(circle at 15% 100%, rgba(75, 240, 252, 0.65) 0%, transparent 25%),
                radial-gradient(circle at 95% 100%, rgba(204, 255, 255, 0.45) 0%, transparent 20%),
                radial-gradient(circle at 100% 100%, rgba(154, 254, 255, 0.55) 0%, transparent 50%),
