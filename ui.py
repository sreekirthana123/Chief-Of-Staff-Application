...
def apply_aurora_app_theme() -> None:
    st.markdown("""
    <style>
    .stApp {
        background: 
            radial-gradient(circle at 15% 100%, rgba(236, 72, 153, 0.45) 0%, transparent 55%),
            radial-gradient(circle at 85% 100%, rgba(168, 85, 247, 0.4) 0%, transparent 50%),
            radial-gradient(circle at 50% 0%, rgba(56, 189, 248, 0.35) 0%, transparent 55%),
